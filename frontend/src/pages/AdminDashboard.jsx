...
const AdminDashboard = () => {
  ...
  // Total desconto dado via cupons
          ...
          <div>
            ...
            <div className="admin-kpi-grid">
              ...
              <div className="admin-kpi-card">
                ...
                <h3 className="admin-kpi-value">R$ {ticketMedio.toFixed(2)}</h3>
              ...
              <div className="admin-kpi-card">
                ...
                <h3 className="admin-kpi-value">R$ {totalDescontos.toFixed(2)}</h3>
                ...
                <div className="admin-bar-chart">
                  {vendasPorMes.map((m, i) => (
                    <div key={i} className="admin-bar-col">
                      <span className="admin-bar-value">R$ {m.total >= 1000 ? (m.total / 1000).toFixed(1) + 'k' : m.total.toFixed(0)}</span>
