      ...
      <div className="footer-grid">
        ...
        <div>
          ...
          <ul className="footer-list">
            ...
            <li><Link to="/catalogo" className="footer-link">Categorias</Link></li>
        ...
        <div>
          ...
          <div className="footer-socials">
            <a href="https://www.instagram.com/uselfclothing/" target="_blank" rel="noopener noreferrer" className="footer-social-link" aria-label="Instagram">
            ...
            <a href="https://wa.me/5583991899900" target="_blank" rel="noopener noreferrer" className="footer-social-link" aria-label="WhatsApp">
